...
if val_one >= val_two and val_two >= val_three:
    print('\n{}, {}, {}.'.format(val_three, val_two, val_one))

elif val_two >= val_one and val_one >= val_three:
    print('\n{}, {}, {}.'.format(val_three, val_one, val_two))

elif val_three >= val_one and val_one >= val_two:
    print('\n{}, {}, {}.'.format(val_two, val_one, val_three))

elif val_one >= val_three and val_three >= val_two:
    print('\n{}, {}, {}.'.format(val_two, val_three, val_one))

elif val_two >= val_three and val_three >= val_one:
    print('\n{}, {}, {}.'.format(val_one, val_three, val_two))

else:
    print('\n{}, {}, {}.'.format(val_one, val_two, val_three))
